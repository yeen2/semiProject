      ...
      <form action="<%=request.getContextPath()%>/declareList.ap" class="form-inline my-2 my-lg-0">
         ...
         <thead>
            ...
            <tr>
               <td><%=d.getD_no() %></td>
               <td id ="tdhover">
                  <a data-toggle ="modal" class="announce" value=<%=d.getD_no() %>>
                     <%=d.getNickname() %>
                  </a>
               </td>
               <td><%=d.getCategory()%></td>
   ...
   $(document).ready(function(){
      $(".announce").click(function(){ // Click to only happen on announce links
         ...
         if(cc == "<%=d.getD_no()%>"){
            ...
            $("#memberFace").attr("src","<%=conPath%>/resources/fileupload/profile/<%=d.getProfile()%>");
         }
         ...
         <div class= "modal-content"> <!-- modal 1  -->
            ...
            <div class="modal-body">
               <div class="form-row" >
                     ...
                     <img src="<%=conPath %>/resources/fileupload/profile/" id="memberFace" 
