		...
		<div class="tile-body"> 
			...
			<form action="<%=conPath%>/q_insert.qu" method="post" >
				<div class="form-group">
                  ...
                  <input class="form-control" type="text" name= "q_title" placeholder="제목">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="10" name="q_content" placeholder="내용"></textarea>
                </div>
              ...
              <a class="btn btn-secondary" href="<%=conPath%>/q_list.qu"><i class="fa fa-fw fa-lg fa-times-circle"></i>취소하기</a>
            </div>
			</form>
