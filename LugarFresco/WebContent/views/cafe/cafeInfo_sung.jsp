...
<body>
	...
	<div class="cafe_outer">
		...
		<div class="jumbotron row"
			style="margin-top: 100px; height: 250px; padding: 0px;">
		...
		<div class="profile-wrapper mt-5" style="margin: 30px; padding: 20px;">
...
<!---------------------------------- review div ------------------------------------->
				...
				<div class="single-testimonial item d-flex flex-row" 
					...
					<div class="desc" style="margin-left: 30px;">
						...
						<div>
							<div class="col-3" 
								style="width: 80px; height: 80px; border: 1px solid gray; float: left;
										margin: 5px;">
							</div>
						</div>
						<% }%>
